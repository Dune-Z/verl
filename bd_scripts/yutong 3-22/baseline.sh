...
PROJECT_NAME=Qwen2.5-7B-gen8-test8
MODEL_NAME=Qwen/Qwen2.5-7B
EXPERIMENT_NAME=ppo_${sft_loss_coef}_gen_8_test_8
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.log_prob_max_token_len_per_gpu=72000 \
    actor_rollout_ref.ref.log_prob_max_token_len_per_gpu=72000 \
