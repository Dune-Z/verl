...
export DATA_DIR=/data/waxinyao-sandbox/r1/math_mix_p606
...
python3 -m verl.trainer.main_ppo \
        ...
        data.val_files=['/data/waxinyao-sandbox/r1/aime_2024/test.parquet','/data/waxinyao-sandbox/r1/math_500_r1/test.parquet'] \
